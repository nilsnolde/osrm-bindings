...
static const std::unordered_map<std::string, RouteParameters::GeometriesType>
    geometries_map{{"polyline", RouteParameters::GeometriesType::Polyline},
...
static const std::unordered_map<std::string, RouteParameters::OverviewType>
    overview_map{{"simplified", RouteParameters::OverviewType::Simplified},
