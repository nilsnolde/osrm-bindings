...
static const std::unordered_map<std::string, BaseParameters::SnappingType>
    snapping_map{{"default", BaseParameters::SnappingType::Default},
                 {std::string(), BaseParameters::SnappingType::Default},
                 {"any", BaseParameters::SnappingType::Any}};

static const std::unordered_map<std::string, BaseParameters::OutputFormatType>
    output_map{{"json", BaseParameters::OutputFormatType::JSON},
