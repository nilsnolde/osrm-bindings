...
void init_TableParameters(nb::module_& m) {
  ...
  nb::class_<TableParameters, BaseParameters>(m, "TableParameters")
      ...
      .def(
          "__init__",
          [](TableParameters* t, std::vector<std::size_t> sources,
             std::vector<std::size_t> destinations,
             const std::vector<TableParameters::AnnotationsType>& annotations, double fallback_speed,
             TableParameters::FallbackCoordinateType fallback_coordinate_type, double scale_factor,
          ...
          "sources"_a = std::vector<std::size_t>(), "destinations"_a = std::vector<std::size_t>(),
          "annotations"_a = std::vector<std::string>(),
          "fallback_speed"_a = osrm::from_alias<double>(INVALID_FALLBACK_SPEED),
          "fallback_coordinate_type"_a = std::string(), "scale_factor"_a = 1.0,
  ...
  nb::class_<TableParameters::AnnotationsType>(m, "TableAnnotationsType")
      ...
      .def(
          "__repr__", [](TableParameters::AnnotationsType type) { return std::to_string((int)type); },
