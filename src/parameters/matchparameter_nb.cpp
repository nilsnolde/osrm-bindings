...
void init_MatchParameters(nb::module_& m) {
  ...
  nb::class_<MatchParameters, RouteParameters>(m, "MatchParameters")
      ...
      .def(
          "__init__",
          [](MatchParameters* t, std::vector<unsigned> timestamps,
             MatchParameters::GapsType gaps_type, bool tidy, const bool steps,
          ...
          "timestamps"_a = std::vector<unsigned>(), "gaps"_a = std::string(), "tidy"_a = false,
          "steps"_a = false, "number_of_alternatives"_a = 0,
          "annotations"_a = std::vector<std::string>(), "geometries"_a = std::string(),
          "overview"_a = std::string(), "continue_straight"_a = std::optional<bool>(),
